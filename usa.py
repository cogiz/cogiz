...
def main():
	...
	USACC = ["Montgomery", "Juneau", "Phoenix", "Little Rock", "Sacramento", "Denver", "Hartford", "Dover","Tallahassee", "Atlanta", "Honolulu", 
			 "Boise", "Springfield", "Indianapolis", "Des Moines", "Topeka","Frankfort", "Baton Rouge", "Augusta", "Annapolis", "Boston", 
			 "Lansing", "St. Paul", "Jackson","Jefferson City", "Helena", "Lincoln", "Carson City", "Concord", "Trenton", "Santa Fe", "Albany",
	...
	selection = print("\033[2;17HYou have chosen the \u001b[1mU.S.A..\033[0m")
	y = len(USA)
	score = 0
	
	for p in range(len(USA)):
		print("\033[2;17HYou have chosen the \u001b[1mU.S.A..\033[0m")       
		print("\033[4;17HThere are %d States in the U.S.A.." % y)
		print("\033[6;17HLet's see how well you know your American geography.")
		print("\033[8;17HGOOD LUCK!")
		print("\033[10;35H*** U.S.A.***")
		print("\033[12;10H*******************************************************************")
		guess = str(input("\033[14;17H\033[0mWhat is the Capital of {}?: \033[0m".format(USA[p], p + 1)))

		if titlecase(guess) in USACC[p]:
			print("\033[16;17H\033[1;32mCongratulations! \033[0mYou are correct.")
			score += 1
			sleep(2)
			tmp = sp.call('clear',shell=True)
		else:
			print("\033[16;17H\033[1;31mSorry! \033[0mYou guessed wrong. The answer was \033[1;33m{}\033[0m".format(USACC[p]))
			score += 0
			sleep(2)
			tmp = sp.call('clear',shell=True)
	...
	print("\033[8;17HGOOD LUCK!")
	print("\033[10;35H*** U.S.A.***")
	print("\033[1;33m\033[12;10H*******************************************************************\033[0m")
