...
def main(): 
	...
	CANADA = ["Alberta", "British Columbia", "Manitoba", "New Brunswick", "Newfoundland and Labrador", "Nova Scotia",
			  "Ontario", "Prince Edward Island", "Quebec", "Saskatchewan", "The Northwest Territories",
			  "The Nunavit Territory", "The Yukon Territory"]

	CANADACC = ["Edmonton", "Victoria", "Winnipeg", "Fredericton", "St. John's", "Halifax", "Toronto", "Charlottetown",
				"Quebec City", "Regina", "Yellowknife", "Iqaluit", "Whitehorse"] 
			
	tmp = sp.call('clear',shell=True)
	selection = print("\033[2;16HYou have chosen \u001b[1mCanada.\033[0m")
	y = len(CANADA)
	score = 0
	
	for p in range(len(CANADA)):
		print("\033[2;16HYou have chosen \u001b[1mCanada.\033[0m")		
		print("\033[4;16HThere are %d Provinces in Canada." % y)
		print("\033[6;16HLet's see how well you know your Canadian geography.")
		print("\033[8;16HGOOD LUCK!")
		print("\033[10;34H*** Canada ***")
		print("\033[12;10H*******************************************************************")
		guess = str(input("\033[14;10H\033[0mWhat is the Capital of {}?: \033[0m".format(CANADA[p], p + 1)))

		if titlecase(guess) in CANADACC[p]:
			print("\033[16;10H\033[1;32mCongratulations! \033[0mYou are correct.")
			score += 1
			sleep(2)
			tmp = sp.call('clear',shell=True)
		else:
			print("\033[16;10H\033[1;31mSorry! \033[0mYou guessed wrong. The answer was \033[1;33m{}\033[0m".format(CANADACC[p]))
			score += 0
			sleep(2)
			tmp = sp.call('clear',shell=True)
